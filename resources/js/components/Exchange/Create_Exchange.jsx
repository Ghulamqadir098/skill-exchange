         ...
         <div class="user-area-section pt-120 pb-120">
          ...
          <option value="" disabled>No skills available</option>
                                 ...
                                 <div class="form_group">
                                     ...
                                     <select name="required_skill" id="required_skill">
                                   
                                     {Array.isArray(all_skills) && all_skills.length > 0 ? (
          ...
          <option value="" disabled>No skills available</option>
                                 ...
                                 <div class="form_group">
                                     <label>Write Down the Details in Easy to Read and Creative Way*</label>
                                ...
                                onChange={newContent=>setContent(newContent)}
                                 ...
                                 <div class="form_group">
                                     <button type="submit" class="main-btn">Create Exchange</button>
                                 </div>
                             </form>
